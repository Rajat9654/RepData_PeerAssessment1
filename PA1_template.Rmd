...
```
The new mean after removing the NA values is **`r Mean2`** which is slightly higher than original mean **`r Mean`**. However, the median remains the same with new median value **`r Median2`** and original being **`r Median`**. 
